-- Insert demo user profiles (these would normally be created via signup)
-- Note: These are demo entries, real profiles are created via the trigger on auth.users
...
('Toyota', 'Camry', 2023, '4T1BE46K87U123456', 'Silver', 12500, 28999.00, 25000.00, 'available', 'gasoline', 'automatic', 'Sedan', 'Silver Metallic', 'Black Cloth', ARRAY['Backup Camera', 'Bluetooth', 'Cruise Control', 'USB Ports'], 'Well-maintained 2023 Toyota Camry with excellent fuel economy and reliability.', ARRAY[]),
('Honda', 'Civic', 2022, '19XFC2F59ME234567', 'Blue', 18200, 24500.00, 22000.00, 'available', 'gasoline', 'manual', 'Sedan', 'Aegean Blue Metallic', 'Gray Cloth', ARRAY['Apple CarPlay', 'Android Auto', 'Lane Keeping Assist', 'Adaptive Cruise Control'], 'Sporty and efficient Honda Civic with advanced safety features.', ARRAY[]),
('Ford', 'F-150', 2023, '1FTEW1EP5PFA34567', 'Red', 8500, 42999.00, 38000.00, 'available', 'gasoline', 'automatic', 'Truck', 'Race Red', 'Black Leather', ARRAY['4WD', 'Tow Package', 'Heated Seats', 'Remote Start'], 'Powerful F-150 pickup truck perfect for work and recreation.', ARRAY[]),
('Tesla', 'Model 3', 2022, '5YJ3E1EA5MF345678', 'White', 22000, 39999.00, 35000.00, 'reserved', 'electric', 'automatic', 'Sedan', 'Pearl White Multi-Coat', 'Black Premium', ARRAY['Autopilot', 'Supercharging', 'Premium Audio', 'Glass Roof'], 'Pre-owned Tesla Model 3 with Autopilot and premium interior.', ARRAY[]),
('BMW', 'X5', 2021, 'WBAJA7C50MCW45678', 'Black', 35000, 52999.00, 48000.00, 'available', 'gasoline', 'automatic', 'SUV', 'Jet Black', 'Cognac Leather', ARRAY['Navigation', 'Panoramic Roof', 'Heated Seats', 'Premium Audio'], 'Luxury BMW X5 with premium features and excellent condition.', ARRAY[]),
('Chevrolet', 'Malibu', 2020, '1G1ZE5ST5LF456789', 'Gray', 45000, 19999.00, 17000.00, 'sold', 'gasoline', 'automatic', 'Sedan', 'Northsky Blue Metallic', 'Jet Black Cloth', ARRAY['Backup Camera', 'OnStar', 'Apple CarPlay'], 'Recently sold Chevrolet Malibu in excellent condition.', ARRAY[]),
('Audi', 'A4', 2023, 'WAUENAF43PN567890', 'Silver', 5200, 45999.00, 42000.00, 'available', 'gasoline', 'automatic', 'Sedan', 'Florett Silver Metallic', 'Black Leather', ARRAY['Quattro AWD', 'Virtual Cockpit', 'Navigation', 'Premium Audio'], 'Nearly new Audi A4 with advanced technology and luxury features.', ARRAY[]),
('Jeep', 'Wrangler', 2022, '1C4HJXEG1NW678901', 'Green', 28000, 36999.00, 33000.00, 'available', 'gasoline', 'manual', 'SUV', 'Sarge Green', 'Black Cloth', ARRAY['4WD', 'Removable Doors', 'Off-Road Package', 'Rock Rails'], 'Adventure-ready Jeep Wrangler perfect for off-road enthusiasts.', ARRAY[]),
('Mercedes-Benz', 'C-Class', 2021, 'WDDWF4HB0MR789012', 'White', 31000, 38999.00, 35000.00, 'in_service', 'gasoline', 'automatic', 'Sedan', 'Polar White', 'Artico Black', ARRAY['Navigation', 'Heated Seats', 'Premium Audio', 'LED Headlights'], 'Elegant Mercedes-Benz C-Class currently in service for maintenance.', ARRAY[]),
('Nissan', 'Altima', 2023, '1N4BL4BV8PC890123', 'Blue', 15000, 26999.00, 24000.00, 'available', 'gasoline', 'automatic', 'Sedan', 'Deep Blue Pearl', 'Charcoal Cloth', ARRAY['ProPILOT Assist', 'Apple CarPlay', 'Blind Spot Warning'], 'Modern Nissan Altima with advanced driver assistance features.', ARRAY[]);
